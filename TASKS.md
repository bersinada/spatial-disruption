...
- [x] Secondary geographic spatial split evaluation
...
- [x] Compare representation levels
- [x] Analyze cross-city degradation
- [x] Analyze failure cases
- [x] Determine whether relational semantics provide additional signal
